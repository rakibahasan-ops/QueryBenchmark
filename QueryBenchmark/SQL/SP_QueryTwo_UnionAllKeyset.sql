-- =====================================================
-- APPROACH 2 — UNION ALL Keyset + Temp Table
-- =====================================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        CREATE CLUSTERED INDEX IX_BaseMembers_A2_CreationDate_EntityId
        ON #BaseMembers_A2(CreationDate DESC, EntityId ASC);
